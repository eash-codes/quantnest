...
class WalletOwnershipRow(Base):
    """Binds a wallet id to the user that owns it.

    Every authorisation check resolves through this table, so a wallet can
    never be read or traded by a user who does not own it.
    """

    __tablename__ = "wallet_ownership"
